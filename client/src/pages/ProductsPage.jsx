            ...
            <div className="max-w-7xl mx-auto">
                <header className="mb-24 flex flex-col lg:flex-row lg:items-end justify-between gap-12">
                    <div className="max-w-2xl">
                        ...
                        <h2 className="text-5xl md:text-4xl font-black tracking-tighter uppercase leading-[0.8] mb-8">Ready <br />To Launch</h2>
                        <p className="text-white/50 text-lg uppercase tracking-[0.2em] font-light italic border-l-4 border-tesla-red pl-8">
